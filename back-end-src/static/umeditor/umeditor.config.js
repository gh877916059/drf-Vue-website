...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"http://127.0.0.1:8000/uploadfile/rich_text_picture/"             //图片上传提交地址
        ,imagePath:URL + "http://127.0.0.1:8000/media/rich_text_picture/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
