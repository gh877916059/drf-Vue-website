...
if __name__ == "__main__":
    ...
    mysql_procedure_path = '"C:/Program Files/MySQL/MySQL Server 5.7/bin/mysql"'
    user_name = default_conf['USER']
    password = default_conf['PASSWORD']
    db_name = default_conf['NAME']
    cmdString = mysql_procedure_path + ' -u' + user_name + ' -p' + password + ' ' + db_name + '<' + db_backup_file_path
    print(cmdString)
    os.system(cmdString)